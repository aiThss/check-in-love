  ...
  `;
    ...
    function renderContentForm() {
        ...
        `;
                ...
                chip.addEventListener('click', () => {
                    if (selectedQuickMsg === msg) {
                        ...
                        const captionInput = contentArea.querySelector('#caption-input');
                        if (captionInput)
      ...
      `;
        ...
        `;
                chip.textContent = msg;
                chip.addEventListener('click', () => {
                    const textarea = contentArea.querySelector('#text-input');
                    if (textarea) {
                        textarea.value = msg;
                        textarea.focus();
                    }
    ...
    sendBtn.addEventListener('click', async () => {
        ...
        if (activeMode === 'photo') {
            ...
            const caption = root.querySelector('#caption-input')?.value.trim();
